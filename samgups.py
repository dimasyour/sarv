...
def tableToTable(region):
    ...
    for i in range(1, len(listK)):
        ...
        wb_od = load_workbook(filename='src/excel/vuzs/od/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_md = load_workbook(filename='src/excel/vuzs/md/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_nd = load_workbook(filename='src/excel/vuzs/nd/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_fe = load_workbook(filename='src/excel/vuzs/fe/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_inf = load_workbook(filename='src/excel/vuzs/inf/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_kadr = load_workbook(filename='src/excel/vuzs/kadr/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_forRegion = load_workbook(filename='src/excel/vuzs/forRegion/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_allInRegion = load_workbook(filename='src/excel/vuzs/allInRegion/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ws_allInRegion = wb_allInRegion.worksheets[0]

        allInRegion1_1 = ws_allInRegion.cell(row=2, column=2).value

        wb_studentInVuz = load_workbook(filename='src/excel/vuzs/studentInVuz/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_procentStudent = load_workbook(filename='src/excel/vuzs/procentStudent/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_dolyaInRegion = load_workbook(filename='src/excel/vuzs/dolyaInRegion/vuz_' + listK[i]['viz_id'] + '.xlsx')
        ...
        wb_dop = load_workbook(filename='src/excel/vuzs/dop/vuz_' + listK[i]['viz_id'] + '.xlsx')
